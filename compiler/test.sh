...
build_run 39 'extern "C" func42 func(); func main() { func42() - 3; }'
build_run 42 'extern "C" funcfunc42 func(); func main() { funcfunc42()(); }'
build_run 4  'extern "C" add func(); func main() { add(add(1, -2), 5); }'
...
build_run 21 'func main(){fib(8);} func fib(n int){ if n<=1 {n;} else {fib(n-1)+fib(n-2);} }'
