...
test_exit 30 'func main() { (1+2) / 2+ (( 3 -4) +5 *  6 ); }'
test_exit 5  'func main() { -3 + (+8); }'
test_exit 2  'func main() { -2 * -1; }'
test_exit 0  'func main() { 3 < (1 + 1); }'
test_exit 1  'func main() { 3 > (1 + 1); }'
...
test_exit 6  'func main() { foo:=2; { foo:=3; } foo+4; }'
test_exit 42 'func main() { return 41+1; 3; }'
test_exit 2  'func main() { 1; if 42 > 10 { 2; } }'
test_exit 2  'func main() { cond := 10 < 200; if cond { return 2; } }'
...
test_exit 5  'func main() { return ga+gb; } var (ga=1, gb=gc+1, gc=3)'
